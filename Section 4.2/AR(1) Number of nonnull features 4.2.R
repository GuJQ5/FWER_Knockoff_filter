...
write.csv(result.table,paste0('/oak/stanford/groups/zihuai/yuxinrui/zihuai/simulation_biometrics_summary/Summary_Feb_Power/k_combo_p',p,'_rho',rho,'19_ar.csv'),row.names=F,col.names=T,quote=F,sep='\t')
