...
result.table = cbind(n.seq,FWER_old_deran,PoWER_old_deran,FWER_old,PoWER_old,FWER_vanilla,PoWER_vanilla,FWER_old_deran_sd,PoWER_old_deran_sd,FWER_old_sd,PoWER_old_sd,FWER_vanilla_sd,PoWER_vanilla_sd)
data1 = result.table 



write.csv(result.table,paste0('/oak/stanford/groups/zihuai/yuxinrui/zihuai/simulation_biometrics_summary/Summary_Feb_Power/n_arp',p,'_rho_',rho,'_500.csv'),row.names=F,col.names=T,quote=F,sep='\t')
