...
write.csv(result.table,paste0('/oak/stanford/groups/zihuai/yuxinrui/zihuai/simulation_biometrics_summary/Summary_Feb_Power/n_cs_p',p,'_rho',rho,'_500.csv'),row.names=F,col.names=T,quote=F,sep='\t')
